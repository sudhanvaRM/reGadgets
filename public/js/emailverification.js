...
let uname = localStorage.getItem('lname');
let emailval = localStorage.getItem('lemail');
let upassword = localStorage.getItem('lpass');
let unumber = localStorage.getItem('lnumber');
let utac = localStorage.getItem('ltac');
let unotification = localStorage.getItem('lnoti');
localStorage.clear();
